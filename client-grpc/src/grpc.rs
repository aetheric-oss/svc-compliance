...
pub mod rpc_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn submit_flight_plan(
            ...
            tonic::Response<super::FlightPlanResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("grpc.RpcService", "submitFlightPlan"));
            self.inner.unary(req, path, codec).await
        }
        /// release flight plan
        pub async fn request_flight_release(
            ...
            tonic::Response<super::FlightReleaseResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("grpc.RpcService", "requestFlightRelease"));
            self.inner.unary(req, path, codec).await
        }
    }
}
